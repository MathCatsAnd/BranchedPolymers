...
{
    public partial class CountChains : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                divOutput.InnerHtml += "Total: 6 = 6*1";
            }
            else
            {
                Polymer[2][0] = 1;
                Polymer[2][1] = 1;
                int total = Tally(Neighbors, Polymer, 2, inputvalue);
                string path = @"C:\Users\juggl\Documents\Math\Research\" + "CountChains.txt";
